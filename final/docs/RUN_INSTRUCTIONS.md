...
7. **Evaluation Protocol / Results** - loads saved artifacts and runs the fixed
   multi-seed set, randomized multi-seed set, bootstrap-CI, training curve, and
   failure taxonomy from disk.
